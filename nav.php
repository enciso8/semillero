    ...
    <nav class="navbar navbar-light bg-light">
        <div class="nav-left">
            ...
            <div class="nav-first-group">
                <div class="menu-top">
                    <a class="navbar-brand" href="#" id="menu-lines">
                ...
                <div class="menu-drop">
                    <ul>
                        ...
                        <li>
                            <a href="#" id="categoriaLink" onclick="mostrarCategorias(event)">
                    ...
                    <div id="categorias" class="categorias oculto">
                        <ul>
                            ...
                            <li>Boletas para Espectáculos</li>
                            <li>Cámaras y Accesorios</li>
                            <li>Carros, Motos y Otros</li>
                            ...
                            <li>Recuerdos, Piñatería y Fiestas</li>
                            <li>Relojes y Joyas</li>
                            <li>Ropa y Accesorios</li>
                            <li>Salud y Equipamiento Médico</li>
                            <li>Servicios</li>
            ...
            <div class="menu-logo">
                <img src="img/logo.png" alt="Logo Comerxia" class="img-logo">
            </div>
        </div>
...
<!--
        ...
        <div class="nav-icon-right">
            ...
            <a  href="login.php" class="nav-icon-right sign-up">
